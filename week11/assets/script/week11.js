...
//Подсказка: Используйте метод для изменения текстового содержимого элемента (innerHTML/innerText/textContent)
const sayHello = document.getElementById('practicum');

function makeOne() {
	sayHello.innerText = 'Привет!';
}
...
//Подсказка: Используйте метод для изменения текстового содержимого элемента (innerHTML/innerText/textContent)
const changeHeader = document.querySelector('section > h1');

function makeThree() {
	changeHeader.innerText = 'Заголовок изменен!';
}
...
const changeBackground = document.querySelector('div#practicum4');
...
const changeValue = document.getElementById('practicum5') ;
function makeFive() {
	changeValue.value = 'Новое значение';
}
...
function makeNine() {
	//Найдите элемент
	const x = document.getElementById('practicum9');
	//Создайте новый элемент
	const y = document.createElement("option");
	//Добавьте текст в созданный эелемент
	y.innerText = 'Новый вариант';
...
function makeTen() {
	const x = document.getElementById('practicum10');
...
function makeEleven() {
	const x = document.getElementById('practicum11');
	x.style.width = "400px";
...
function makeTwelve() {
	const x = document.querySelector('div#practicum12');
	x.classList.toggle('resizeable-large');
}

document.querySelector('div#practicum12').onclick = makeTwelve;
...
function makeThirteen() {
	const x = document.querySelector('ol:first-child'); //при использовании getElementsByTagName псевдокласс:first-child не срабатывает
	x.textContent = " Первый! ";
}
...
function makeFourteen() {
	...
	paragraphs.forEach(function (paragraphs) {
		...
		//Измените их текстовое содержимое у paragraphs
	});
}
...
function makeFifteen() {
	const x = document.getElementById('practicum15');
	x.classList.remove('practicum15');
}
...
function makeSixteen() {
	const x = document.getElementById('practicum16');
	x.classList.add('practicum16');
}
...
function makeSeventeen() {
	const x = document.getElementById('practicum17');
...
function makeEighteen() {
	const x = document.getElementById('practicum18');
...
function makeNineteen() {
	const x = document.getElementById('practicum19');
...
function makeTwenty() {
	const x = document.getElementById('practicum20');
	const y = document.createElement("p");
	y.innerText = ' Добавлено в начало ';
	x.prepend(y);
}
...
function makeTwentyOne() {
	const x = document.getElementById('practicum21');
	const y = document.createElement("p");
	y.innerText = ' Добавлено в конец ';
	x.append(y);
}
...
function makeTwentyTwo() {
	...
	result22.innerText = 'Атрибут "src" присутствует: ' + y;
}
...
function makeTwentyThree() {
	const x = document.getElementById('practicum23');
...
function makeTwentyFour() {
	const x = document.getElementById('practicum24');
	x.setAttribute('value', 'Новое значение');
}
...
function makeTwentySeven() {
	//Найдите переменную
	const x = document.getElementById('practicum27');
	...
	const result = x.classList.contains('highlight');
...
buttonTaskTwentyEight.addEventListener( "click" , () => { 
...
const taskTwentyNine = document.getElementById('input29');

taskTwentyNine.addEventListener('change', () => {
...
const taskThirty = document.getElementById('div30');

taskThirty.addEventListener('mouseover', () => {
